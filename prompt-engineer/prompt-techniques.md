...
## Zero-Shot
Zero-shot prompting is a technique that involves generating text from an LLM without additional training or fine-tuning. The term 'Shot' refers to examples or training data. In zero-shot prompting, the model generates text without any examples or training data.
